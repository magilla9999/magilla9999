Last login: Mon Dec 15 07:40:12 on ttys002
You have mail.
michaelwagner@michaels-Mac-mini ~ % cd
michaelwagner@michaels-Mac-mini ~ % cdwip
michaelwagner@michaels-Mac-mini features % view process_special_days.pl
michaelwagner@michaels-Mac-mini features % cdwip
michaelwagner@michaels-Mac-mini features % cd ../../railscanpro/GIT_REPOS/RailScanPro_REPO 
michaelwagner@michaels-Mac-mini RailScanPro_REPO % cd docs/testing
michaelwagner@michaels-Mac-mini testing % view USER-TESTING-GUIDE.md

Last login: Mon Sep 29 09:53:55 on ttys001
You have mail.
michaelwagner@michaels-Mac-mini ~ % pwd
/Users/michaelwagner
michaelwagner@michaels-Mac-mini ~ % cd RailScanPro 
michaelwagner@michaels-Mac-mini RailScanPro % ls
docs					UI-TESTING.md				USER-TESTING-GUIDE-from-chatgpt.md
README.md				UI-TESTING2.md				USER-TESTING-GUIDE.md
michaelwagner@michaels-Mac-mini RailScanPro % vi UI-TESTING.md
michaelwagner@michaels-Mac-mini RailScanPro % mv UI-TESTING2.md          
usage: mv [-f | -i | -n] [-hv] source target
       mv [-f | -i | -n] [-v] source ... directory
michaelwagner@michaels-Mac-mini RailScanPro % vi !$
vi UI-TESTING2.md
michaelwagner@michaels-Mac-mini RailScanPro % vi USER-TESTING-GUIDE-from-chatgpt.md 
michaelwagner@michaels-Mac-mini RailScanPro % view USER*
2 files to edit
michaelwagner@michaels-Mac-mini RailScanPro % 
michaelwagner@michaels-Mac-mini RailScanPro % 
michaelwagner@michaels-Mac-mini RailScanPro % vi USER-TESTING-GUIDE.md 
...
| Sign In| Top Bar | Click | Navigate to sign in page | Pass | Does include greyed out Google / Apple / Facebook (assuming these will be enabled at some point) . Be nice if there was a show readable password |
| Forgot password | Sign In | Click | Navigate to Reset your password page| Pass | Notes |
| Send Reset Link | Forgot password | Sign In | Click | Navigate to Reset your password page| Pass | Password Reset Request received |
| Password Reset Request | Forgot password | Sign in | Click | Password reset link navigates to Reset your password page | Fail | get error Password reset failed. The link may be invalid or expired.|
| Password Reset Request | Forgot password | Sign in | Click | Password reset link navigates to Reset your password page | Pass (iphone) | get error Password reset failed. The link may be invalid or expired.|
